...
async def main():
    ...
    #move back
    await motor_pair.move_for_degrees(
        motor_pair.PAIR_1, -60, 0, velocity=400
    )# go back out of tip the scales
    await motor_pair.move_tank_for_degrees(
        motor_pair.PAIR_1, -505, 0, 600
    )# turn towards base
    await motor_pair.move_for_degrees(
        motor_pair.PAIR_1, -700, 0, velocity=800
    )# go to base

    await motor_pair.move_tank_for_degrees(
        motor_pair.PAIR_1, -180, 0, 600
    )# turn towards base
    await motor_pair.move_for_degrees(
        motor_pair.PAIR_1, -1000, 0, velocity=800
    )# go to base

...
# ############################################!111111111111111111111111111111!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 400, 0, velocity=550)

    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, 100, 0, 600)

    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 200, 0, velocity=650)

    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, 70, 0, 600)


    await motor_pair.move_for_degrees(motor_pair.PAIR_1, 1400, 0, velocity=650)

...
async def main():
    ...
    await move_straight_for_degrees(port.F, port.E, 300, 400)
    #Turn near the oval
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, -165, 300, -0,)

    # Move forward
    await move_straight_for_degrees(port.F, port.E, 750, 400)
    ...
    # One-way Door down
    await motor.run_for_degrees(port.D, 210, -400)
    ...
    await motor.run_for_degrees(port.D, 210, 400)
    #Move backward
    await move_straight_for_degrees(port.F, port.E, 170, -200)
    ...
    await move_straight_for_degrees(port.F, port.E, 360, -200)
    # forward a bit
    await move_straight_for_degrees(port.F, port.E, 560, 200)
    #turn
    ...
    #forward
    await move_straight_for_degrees(port.F, port.E, 620, 200)
    #arm up to complete mineshaft
    await motor.run_for_degrees(port.D, 150, 75)
    #turn to align with oval
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, 340, 400, -0,)
    #forward
    await move_straight_for_degrees(port.F, port.E, 180, 200)
    #drop the topsoil
    await motor.run_for_degrees(port.C, 140, 100)
    await move_straight_for_degrees(port.F, port.E, 180, -200)
    await motor_pair.move_tank_for_degrees(motor_pair.PAIR_1, -500, 380, -0,)
